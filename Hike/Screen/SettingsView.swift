        ...
        List {
            ...
            Section(header: Text("Alternate Icons")) {
                ScrollView(.horizontal, showsIndicators: false) {
                    ...
                    }// TIP!!! Add this to ever ListView with buttons
                }//: SCROLL VIEW
                .padding(.top, 12)
            ...
            Section(
                ...
                CustomListRowView(rowLabel: "Aplpication", rowIcon: "apps.iphone", rowContent: "HIKE", rowTintColor: .blue)
                ...
                CustomListRowView(rowLabel: "Developer", rowIcon: "ellipsis.curlybraces", rowContent: "Eduardo Viñoles", rowTintColor: .mint)
